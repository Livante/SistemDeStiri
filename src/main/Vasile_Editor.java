...
public class Vasile_Editor implements Runnable {
	...
	public void run() {
		...
		editor.publicareStiri("Politica", "Kim Jung-un",
				"Kim Jung un a arestat toti cetatenii care nu se tund ca si el");
		editor.publicareStiri("Pandemie", "Vaccine",
